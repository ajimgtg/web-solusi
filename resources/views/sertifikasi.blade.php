...
@section('my-css')
    <link rel="stylesheet" href="{{ asset('css/custom/sertifikasi-bnsp.css') }}" />
@endsection

@section('content')
    <!-- Jumbotron -->
    <section class="jumbotron text-center" style="margin-top: 56px">
        <h1 class="display-4">Sertifikasi BNSP</h1>
        <p class="desc-jumb">Buktikan Kompetensimu, Raih Sertifikat Resmi BNSP dengan mengikuti Sertifikasi BNSP di LAB
            INSYDE</p>
    </section>
    <!-- Akhir Jumbotron -->
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4 penjelasan" style="padding-top: 50px; padding-bottom: 50px">
                ...
                <div class="col">
                    ...
                    <form action="{{ route('sertifikasi.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputLayanan" class="form-label">Skema Sertifikasi Yang Ingin Anda
                                Ikuti</label>
                            <input type="text" class="form-control" id="exampleInputLayanan" name="skema_sertifikasi"
                                placeholder="Informasikan Skema Sertifikasi Yang Ingin Anda Ikuti" required />
                        </div>

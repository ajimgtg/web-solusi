...
@section('content')
    ...
    <section class="jumbotron text-center" style="margin-top: 56px">
        <h1 class="display-4">Katalog Produk</h1>
        <p class="lead" style="font-weight: 400">Pantau terus halaman ini, untuk informasi produk terbaru dari kami.</p>
    </section>
    <!-- Akhir Jumbotron -->
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a class="dtl" href="{{ route('product.show', $item->id) }}"
